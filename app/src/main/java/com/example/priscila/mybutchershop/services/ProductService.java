 ...
 *
 * This class is a mock service that gets data
 * and implements methods that returns products list
 * and product detail by ID.
 */
...
public class ProductService {
    ...
    private Map<Integer,ProductDetail> getData() {
        ...
        // parse data to ProductDetail class
    ...
    // method to create list of products to display in listview
